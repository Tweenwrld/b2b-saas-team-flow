...
import VercelLogo from '../../../../public/companies/vercel-logo.png'
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                <TextEffect
                                    ...
                                    Tailflow organizes conversations into channels with threads, is realtime, and uses AI to keep teams in sync.
                                </TextEffect>
                ...
                <section className="bg-background pb-16 pt-16 md:pb-32">
                    <div className="group relative m-auto max-w-5xl px-6">
                        ...
                        <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
                            <div className="flex">
                                <Image
                                    className="mx-auto h-7 w-fit object-contain dark:invert"
                                    src={ArcjetLogo}
                                    alt="Arcjet Logo"
                                />
                            </div>
